...
public class BpmConsumer {
    ...
    public void handleBpmCommand(
        ...
        log.info("Принято сообщение из топика order-commands");
        ...
        try {
            ...
            if (json.contains("\"transactionId\"")) {
                ...
                UpdateOrderStatusCommand updateCommand = objectMapper.readValue(value, UpdateOrderStatusCommand.class);
                orderService.completeOrder(updateCommand);

            } else if (json.contains("\"reason\"")) {

                CancelOrderCommand failedCommand = objectMapper.readValue(value, CancelOrderCommand.class);
